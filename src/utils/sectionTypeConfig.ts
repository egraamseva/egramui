...
export function mapOldSectionType(oldType: string): SectionType {
  const mapping: Record<string, SectionType> = {
    ...
    'CARDS': 'CARD_SECTION',
    'CARD_GRID': 'CARD_GRID', // CARD_GRID is now supported in backend enum
    'FAQ': 'FAQ_SECTION',
    'FORM': 'FORM_SECTION',
    'VIDEO': 'VIDEO_SECTION',
    ...
    'CONTENT_SECTION': 'PARAGRAPH_CONTENT', // Map CONTENT_SECTION to PARAGRAPH_CONTENT
    'MAP': 'MAP_SECTION',
...
export function mapToBackendSectionType(frontendType: string): string {
  ...
  const reverseMapping: Record<string, string> = {
    ...
    'CARD_SECTION': 'CARDS',
    'CARD_GRID': 'CARDS', // Map CARD_GRID to CARDS for backward compatibility
    'FAQ_SECTION': 'FAQ',
    'FORM_SECTION': 'FORM',
    'VIDEO_SECTION': 'VIDEO',
    ...
    'CONTENT_SECTION': 'CONTENT_SECTION', // CONTENT_SECTION is now supported in backend enum
    'MAP_SECTION': 'MAP',
