...
export const HARDCODED_SCHEMAS: SectionSchema[] = [
  ...
  {
    id: 13,
    schemaType: 'TEAM_MEMBERS',
    name: 'Team Members',
    description: 'Display team members, elected representatives, or staff with photos, names, roles, and descriptions',
    category: 'Cards & Grids',
    version: 1,
    isActive: true,
    isSystem: true,
    ...
    fieldDefinitions: [
      {
        ...
        isRepeatable: true,
        nestedFields: [
          { id: 'memberTitle', name: 'title', type: 'TEXT', label: 'Name', required: true, placeholder: 'Enter member name', displayOrder: 1, validationRules: [{ ruleType: 'MIN_LENGTH', ruleValue: '2', errorMessage: 'Name must be at least 2 characters' }] },
          { id: 'memberSubtitle', name: 'subtitle', type: 'TEXT', label: 'Role/Position', required: false, placeholder: 'e.g., Sarpanch, Ward Member', displayOrder: 2 },
          { id: 'memberDescription', name: 'description', type: 'RICHTEXT', label: 'Description', required: false, placeholder: 'Optional description or bio', displayOrder: 3 },
          { id: 'memberImage', name: 'image', type: 'IMAGE', label: 'Photo', required: false, placeholder: 'Upload member photo', displayOrder: 4 },
          { id: 'memberLink', name: 'link', type: 'URL', label: 'Profile Link', required: false, placeholder: 'Optional link to profile page', displayOrder: 5 },
        ],
      },
  ...
  {
    id: 26,
    schemaType: 'SOCIAL_MEDIA_LINKS',
    name: 'Social Media Links',
    description: 'Display social media links and icons for connecting with the community',
    category: 'Interactive',
    version: 1,
    isActive: true,
    isSystem: true,
    ...
    fieldDefinitions: [
      {
        ...
        isRepeatable: true,
        nestedFields: [
          { id: 'socialTitle', name: 'title', type: 'TEXT', label: 'Platform Name', required: true, placeholder: 'Facebook, Twitter, etc.', displayOrder: 1 },
          { id: 'socialLink', name: 'link', type: 'URL', label: 'URL', required: true, placeholder: 'https://facebook.com/...', displayOrder: 2 },
          { id: 'socialIcon', name: 'icon', type: 'TEXT', label: 'Icon Name', required: false, placeholder: 'facebook, twitter, youtube, etc.', displayOrder: 3 },
          { id: 'socialImage', name: 'image', type: 'IMAGE', label: 'Icon Image', required: false, displayOrder: 4 },
          { id: 'socialDescription', name: 'description', type: 'TEXT', label: 'Description', required: false, placeholder: 'Optional description', displayOrder: 5 },
        ],
      },
      { id: 'columns', name: 'columns', type: 'NUMBER', label: 'Number of Columns', required: false, defaultValue: '4', displayOrder: 2, validationRules: [{ ruleType: 'MIN', ruleValue: '1' }, { ruleType: 'MAX', ruleValue: '6' }] },
    ],
    supportedLayouts: ['ROW', 'GRID'],
    defaultLayout: 'ROW',
    renderingHints: {
